...
class Test3ChunkEditorView: UIView {
    ...
    weak var fadeEditor:   Test3ChunkFadeEditor!
    weak var seedEditor:   Test3ChunkSeedEditor!
    ...
    init(controller: Test3GameController, gameView: GameView3) {
    ...
    private func setupViews() {
        ...
        // Fade Editor
        let fadeEditor = Test3ChunkFadeEditor(controller: gameController)
        ...
        // Seed Editor
        let seedEditor = Test3ChunkSeedEditor(controller: gameController)
