//
//  Test3ChunkSeedEditor.swift
//  game
//
//  Created by Jackson Tubbs on 3/24/21.
//

import UIKit

class Test3ChunkSeedEditor: UIView {
    ...
    @objc private func updateSeed() {
        ...
        gameController.map.seed = seed
        gameController.map.updateNoiseSource()
        gameController.map.reloadMap()
    }
    ...
    private func setupViews() {
        ...
        valueTextField.font = UIFont(name: UIFont.robotoBold, size: 14)
        ...
        randomizeButton.titleLabel?.font = UIFont(name: UIFont.robotoBold, size: 14)
